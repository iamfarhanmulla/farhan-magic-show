...
const SplashScreen = ({ onComplete }) => {
    ...
    return (<div className="splash-container fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background">
      {/* Decorative dots */}
      ...
      <div className="relative flex flex-col items-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight flex overflow-hidden">
          {name.split("").map((char, i) => (<span key={i} className="splash-letter inline-block opacity-0" style={{ minWidth: char === " " ? "0.3em" : undefined }}>
              {char === " " ? "\u00A0" : char}
            </span>))}
        </h1>
